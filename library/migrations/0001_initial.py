    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genres', models.CharField(blank=True, help_text='Напишите жанр', max_length=100, null=True, verbose_name='Жанр')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Дата обновления')),
                ('status', models.CharField(choices=[('AVAILABLE', 'Доступна'), ('RESERVED', 'Зарезервирована'), ('LOANED', 'Выдана')], default='AVAILABLE', max_length=10)),
                ('author', models.ForeignKey(help_text='Укажите автора', on_delete=django.db.models.deletion.CASCADE, to='library.author', verbose_name='Автор')),
                ('owner', models.ForeignKey(help_text='Укажите пользователя', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
                'verbose_name': 'Книга',
